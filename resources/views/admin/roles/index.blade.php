                ...
                @can('create roles')
                    <div class="d-flex align-items-center gap-2 gap-lg-3">
                        <a class="btn btn-sm fw-bold btn-primary" data-bs-toggle="modal"
                            data-bs-target="#kt_modal_add_role">اضافه </a>
                    </div>
                @endcan
            </div>
        </div>
                                                ...
                                                <td class="text-center d-flex gap-2 justify-content-center">
                                                    @can('edit roles')
                                                        <a href="{{ route('admin.roles.edit', $role->id) }}"
                                                            class="btn btn-bg-light btn-color-muted btn-active-color-primary btn-sm px-4">تعديل</a>
                                                    @endcan
                                                    @can('delete roles')
                                                        <form action="{{ route('admin.roles.delete', $role->id) }}"
                                                            ...
                                                            @method('DELETE')
                                                            <button type="submit"
                                                                class="btn btn-bg-light btn-color-muted btn-active-color-danger btn-sm px-4">حذف</button>
                                                        </form>
                                                    @endcan
                                                </td>
                                            @endif
                        ...
                        <form id="kt_modal_add_role_form" action="{{ route('admin.roles.store') }}"
                            ...
                            <div class="d-flex flex-column scroll-y me-n7 pe-7" id="kt_modal_add_role_scroll"
                                ...
                                <div class="fv-row mb-10 fv-plugins-icon-container">
                                    ...
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                    <input class="form-control form-control-solid" placeholder="ادخل اسم الدور"
                                ...
                                <div class="fv-row">
                                    ...
                                    <table class="table align-middle table-row-dashed fs-6 gy-5">
                                        ...
                                        <tbody class="text-gray-600 fw-semibold">
                                            <!--begin::Table row-->
                                            <tr>
                                                <td class="text-gray-800">وصول المسؤول <i
                                                ...
                                                <td>
                                                    ...
                                                    <label onclick="selectAll()"
                                                        ...
                                                        <span class="form-check-label" for="kt_roles_select_all">اختيار
                                                            الكل</span>
                                                    </label>
                                                    <!--end::Checkbox-->
                                                </td>
                            ...
                            <div class="text-center pt-15">
                                <button type="submit" class="btn btn-primary" data-kt-roles-modal-action="submit">
                                    ...
                                    <span class="indicator-progress">من فضلك انتظر <span
